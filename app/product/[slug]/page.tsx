...
// ssr rendering.
//if using actual database, the combination of ssr for seo and csr for products details 
//& related data is better for fast page load and RTK query can be use for csr caching.
